...
IMPLEMENT_ENUM_CLASS_BEGIN(e2dEffectType)
ADD_ENUM(e2dEffectType::LIGHT, "light")
ADD_ENUM(e2dEffectType::PARTICLE, "particle")
ADD_ENUM(e2dEffectType::ATTRACTOR, "ped_attractor")
ADD_ENUM(e2dEffectType::SUN_GLARE, "sun_glare")
ADD_ENUM(e2dEffectType::FURNITURE, "furniture")
ADD_ENUM(e2dEffectType::ENEX, "enter_exit")
ADD_ENUM(e2dEffectType::ROADSIGN, "roadsign")
ADD_ENUM(e2dEffectType::TRIGGER_POINT, "trigger_point")
ADD_ENUM(e2dEffectType::COVER_POINT, "cover_point")
ADD_ENUM(e2dEffectType::ESCALATOR, "escalator")
IMPLEMENT_ENUM_CLASS_END("2dfx-type")

IMPLEMENT_ENUM_CLASS_BEGIN(e2dCoronaFlashType)
ADD_ENUM(e2dCoronaFlashType::DEFAULT, "default")
ADD_ENUM(e2dCoronaFlashType::RANDOM, "random_flashing")
ADD_ENUM(e2dCoronaFlashType::RANDOM_WHEN_WET, "random_at_wet_weather")
ADD_ENUM(e2dCoronaFlashType::ANIM_SPEED_4X, "anim_speed_4x")
ADD_ENUM(e2dCoronaFlashType::ANIM_SPEED_2X, "anim_speed_2x")
ADD_ENUM(e2dCoronaFlashType::ANIM_SPEED_1X, "anim_speed_1x")
ADD_ENUM(e2dCoronaFlashType::WARNLIGHT, "warnlight")
ADD_ENUM(e2dCoronaFlashType::TRAFFICLIGHT, "trafficlight")
ADD_ENUM(e2dCoronaFlashType::TRAINCROSSING, "traincrosslight")
ADD_ENUM(e2dCoronaFlashType::ONLY_RAIN, "at_rain_only")
ADD_ENUM(e2dCoronaFlashType::ON5_OFF5, "on_off_at_5")
ADD_ENUM(e2dCoronaFlashType::ON6_OFF4, "on_at_6_off_at_4")
ADD_ENUM(e2dCoronaFlashType::ON4_OFF6, "on_at_4_off_at_6")
IMPLEMENT_ENUM_CLASS_END("2dfx-light-mode")

IMPLEMENT_ENUM_CLASS_BEGIN(e2dEffectTextureName)
ADD_ENUM(e2dEffectTextureName::CORONA_STAR, "coronastar")
ADD_ENUM(e2dEffectTextureName::SHAD_HELI, "shad_heli")
ADD_ENUM(e2dEffectTextureName::SHAD_EXP, "shad_exp")
ADD_ENUM(e2dEffectTextureName::SHAD_CAR, "shad_car")
ADD_ENUM(e2dEffectTextureName::SHAD_BIKE, "shad_bike")
ADD_ENUM(e2dEffectTextureName::SEABD32, "seabd32")
ADD_ENUM(e2dEffectTextureName::ROADSIGNFONT, "roadsignfont")
ADD_ENUM(e2dEffectTextureName::PARTICLESKID, "particleskid")
ADD_ENUM(e2dEffectTextureName::LUNAR, "lunar")
ADD_ENUM(e2dEffectTextureName::LOCKONFIRE, "lockonFire")
ADD_ENUM(e2dEffectTextureName::LOCKON, "lockon")
ADD_ENUM(e2dEffectTextureName::LAMP_SHAD_64, "lamp_shad_64")
ADD_ENUM(e2dEffectTextureName::HEADLIGHT1, "headlight1")
ADD_ENUM(e2dEffectTextureName::HEADLIGHT, "headlight")
ADD_ENUM(e2dEffectTextureName::HANDMAN, "handman")
ADD_ENUM(e2dEffectTextureName::FINISHFLAG, "finishflag")
ADD_ENUM(e2dEffectTextureName::CORONARINGB, "coronaringb")
ADD_ENUM(e2dEffectTextureName::CORONAREFLECT, "coronareflect")
ADD_ENUM(e2dEffectTextureName::CORONAMOON, "coronamoon")
ADD_ENUM(e2dEffectTextureName::CORONAHEADLIGHTLINE, "coronaheadlightline")
ADD_ENUM(e2dEffectTextureName::CLOUDMASKED, "cloudmasked")
ADD_ENUM(e2dEffectTextureName::CLOUDHIGH, "cloudhigh")
ADD_ENUM(e2dEffectTextureName::CLOUD1, "cloud1")
ADD_ENUM(e2dEffectTextureName::CARFX1, "carfx1")
ADD_ENUM(e2dEffectTextureName::BLOODPOOL_64, "bloodpool_64")
ADD_ENUM(e2dEffectTextureName::WINCRACK_32, "wincrack_32")
ADD_ENUM(e2dEffectTextureName::WHITE, "white")
ADD_ENUM(e2dEffectTextureName::WATERWAKE, "waterwake")
ADD_ENUM(e2dEffectTextureName::WATERCLEAR256, "waterclear256")
ADD_ENUM(e2dEffectTextureName::TXGRASSBIG1, "txgrassbig1")
ADD_ENUM(e2dEffectTextureName::TXGRASSBIG0, "txgrassbig0")
ADD_ENUM(e2dEffectTextureName::SHAD_RCBARON, "shad_rcbaron")
ADD_ENUM(e2dEffectTextureName::SHAD_PED, "shad_ped")
IMPLEMENT_ENUM_CLASS_END("2dfx-texture-name")

IMPLEMENT_ENUM_CLASS_BEGIN(e2dEffectProperty)
ADD_ENUM(e2dEffectProperty::FAR_CLIP_DISTANCE, "drawDistance")
ADD_ENUM(e2dEffectProperty::LIGHT_RANGE, "lightRange")
ADD_ENUM(e2dEffectProperty::CORONA_SIZE, "coronaSize")
ADD_ENUM(e2dEffectProperty::SHADOW_SIZE, "shadowSize")
ADD_ENUM(e2dEffectProperty::SHADOW_MULT, "shadowMultiplier")
...
ADD_ENUM(e2dEffectProperty::SIZE_X, "sizeX")
ADD_ENUM(e2dEffectProperty::SIZE_Y, "sizeY")
...
ADD_ENUM(e2dEffectProperty::TEXT_4, "text4")

ADD_ENUM(e2dEffectProperty::BOTTOM_X, "bottomX")
ADD_ENUM(e2dEffectProperty::BOTTOM_Y, "bottomY")
ADD_ENUM(e2dEffectProperty::BOTTOM_Z, "bottomZ")
ADD_ENUM(e2dEffectProperty::TOP_X, "topX")
ADD_ENUM(e2dEffectProperty::TOP_Y, "topY")
ADD_ENUM(e2dEffectProperty::TOP_Z, "topZ")
ADD_ENUM(e2dEffectProperty::END_X, "endX")
ADD_ENUM(e2dEffectProperty::END_Y, "endY")
ADD_ENUM(e2dEffectProperty::END_Z, "endZ")
ADD_ENUM(e2dEffectProperty::DIRECTION, "direction")
IMPLEMENT_ENUM_CLASS_END("2dfx-property-name")
